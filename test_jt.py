...
def getLink():
    ...
    # 'getEfcyDplctInfoList', 'getDurPrdlstInfoList','getSeobangjeongPartitnAtentInfoList','getOdsnAtentInfoList', 'getMdctnPdAtentInfoList','getCpctyAtentInfoList',
    urlList = 'getPwnmTabooInfoList', 'getSpcifyAgrdeTabooInfoList', 'getUsjntTabooInfoList',
